...
export const siteConfig: SiteConfig = {
	title: "TITLE",
	subtitle: "SUBTITLE",
	siteURL: "https://nf3eb.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-06", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "2089017483", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			typewriter: {
				...
				speed: 80, // 打字速度（毫秒）
				deleteSpeed: 35, // 删除速度（毫秒）
				pauseTime: 1600, // 完全显示后的暂停时间（毫秒）
			},
		},
	...
	favicon: [
		{
		  src: '/favicon/defect1.png',    // 图标文件路径
